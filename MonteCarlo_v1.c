...
/*
   To compile:
      gcc -o MonteCarlo_v1 MonteCarlo_v1.c -pthreads
   To run:
      ./MonteCarlo_v1 10

NOTE the order of the output of the thread ids, not always and maybe never in
ascending order.
...
void * MonteCarlo(void * Number_of_Point) 
{
   ...
   for(i=0; i < (rand_Pi->Number_of_points); i++)  {
